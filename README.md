...
- `protoss fmt [--check] <file>` prints the trusted Protoss/H AST projection for any parseable human source. Formatting is idempotent over the supported declaration grammar and preserves parseability.
