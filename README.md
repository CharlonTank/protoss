...
- Cursor/VS Code syntax highlighting for `.protoss` files is available in `editors/cursor/protoss-syntax`; copy it to `~/.cursor/extensions/protoss.protoss-syntax-0.1.0` and restart Cursor.
