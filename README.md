...
- `git map [project]` builds the project and writes `.protoss/git.map`, mapping the current Git commit to the current `UniverseRoot` and the current Git branch to a content-derived Universe branch ref.
